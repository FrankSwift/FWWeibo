...
+ (instancetype)cellWithTableView:(UITableView *)tableView
{
    ...
    FWCommonCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        cell = [[FWCommonCell alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:ID];
    }
    return cell;
}
...
- (void)setItem:(FWCommonItem *)item
{
    _item = item;
...
//    } else
//        if ([item isKindOfClass:[HMCommonArrowItem class]]) {
