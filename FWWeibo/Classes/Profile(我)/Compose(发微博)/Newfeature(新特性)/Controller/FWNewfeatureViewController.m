...
@interface FWNewfeatureViewController () <UIScrollViewDelegate>
@property (nonatomic, weak) UIPageControl *pageControl;
@end
@implementation FWNewfeatureViewController
...
//    scrollView.backgroundColor = HMColor(246, 246, 246);
    scrollView.backgroundColor = KColor(orangeColor);
...
- (void)start
{
    ...
    FWTabBarViewController *vc = [[FWTabBarViewController alloc] init];
